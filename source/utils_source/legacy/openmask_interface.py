...
def get_mask_clip_features() -> None:
    ...
    with open(zipfile, "rb") as f:
        try:
            ...
            # [User Request] Increased timeout to 1800s to avoid timeouts during slow CPU processing
            response = requests.post(server_address, files={"scene": f}, params=kwargs, timeout=1800)
